...
class TestParadataLoggerCounters:
    ...
    def test_log_success_multiple_output_types(self, tmp_path):
        logger = ParadataLogger(
            PROGRAM_NAME, {}, output_types=["csv", "xml"], paradata_dir=str(tmp_path)
        )
    ...
    def test_log_document_success_takes_precedence_over_output_counts(self, tmp_path):
        ...
        """
        logger = ParadataLogger(PROGRAM_NAME, {}, output_types=["tsv"], paradata_dir=str(tmp_path))
...
class TestParadataLoggerConfigSnapshot:
    ...
    def test_state_roundtrip_preserves_counts_and_skips(self, tmp_path):
        ...
        logger = ParadataLogger(PROGRAM_NAME, {"a": 1}, paradata_dir=str(tmp_path))
